...
// import { BarChart3, Users, Package, ShoppingCart, Settings, LogOut } from "lucide-react"
  ...
  return (
    <Sidebar collapsible="icon" {...props}>
      <SidebarHeader className="border-b h-16">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className="w-[85%] hover:!bg-transparent hover:!text-inherit">
              <Link href="/admin/dashboard">
                 <div>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110 19" className={`${state == 'collapsed' ? 'w-[100px] mt-4': 'w-[100%]'} `}>
